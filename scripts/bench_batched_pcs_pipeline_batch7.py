...
Usage:
    ...
    python3 scripts/bench_batched_pcs_pipeline_batch7.py --no-run --input bench_output.txt
    python3 scripts/bench_batched_pcs_pipeline_batch7.py --output batched_pcs_table_batch7.tex
"""
...
BENCH_FILTER = "Batched PCS Pipeline Suite BPoly31 1row batch7/.* poly_size=2\\^(9|10|11) "
CARGO_BENCH_CMD = [
    "cargo", "bench",
