...
def generate_latex_table(
    ...
    lines = [
        ...
        r"\label{tab:batched-pcs-pipeline-suite-bpoly31-1row-d2}",
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Batched PCS pipeline (Encode/Merkle/Commit/Test/Verify) benchmarks for BPoly<31> with num_rows=1, depth=2 and produce a LaTeX table."
    )
    parser.add_argument(
        "--no-run",
        action="store_true",
