//! Benchmark: Zip commit to 40 polynomials with 6–10 variables.
...
fn zip_commit_40_polys_r12d1(c: &mut Criterion) {
...
fn zip_commit_40_polys_r12d2(c: &mut Criterion) {
...
fn zip_commit_40_polys_r14d1(c: &mut Criterion) {
...
fn zip_commit_40_polys_r14d2(c: &mut Criterion) {
...
fn zip_test_40_polys_r12d1(c: &mut Criterion) {
...
fn zip_test_40_polys_r12d2(c: &mut Criterion) {
...
fn zip_test_40_polys_r14d1(c: &mut Criterion) {
...
fn zip_test_40_polys_r14d2(c: &mut Criterion) {
...
fn zip_evaluate_40_polys_r12d1(c: &mut Criterion) {
...
fn zip_evaluate_40_polys_r12d2(c: &mut Criterion) {
...
fn zip_evaluate_40_polys_r14d1(c: &mut Criterion) {
...
fn zip_evaluate_40_polys_r14d2(c: &mut Criterion) {
...
fn zip_verify_40_polys_r12d1(c: &mut Criterion) {
...
fn zip_verify_40_polys_r12d2(c: &mut Criterion) {
...
fn zip_verify_40_polys_r14d1(c: &mut Criterion) {
...
fn zip_verify_40_polys_r14d2(c: &mut Criterion) {
...
criterion_group!(
    benches,
    zip_commit_40_polys_r12d1,
    zip_commit_40_polys_r12d2,
    zip_commit_40_polys_r14d1,
    zip_commit_40_polys_r14d2,
    zip_test_40_polys_r12d1,
    zip_test_40_polys_r12d2,
    zip_test_40_polys_r14d1,
    zip_test_40_polys_r14d2,
    zip_evaluate_40_polys_r12d1,
    zip_evaluate_40_polys_r12d2,
    zip_evaluate_40_polys_r14d1,
    zip_evaluate_40_polys_r14d2,
    zip_verify_40_polys_r12d1,
    zip_verify_40_polys_r12d2,
    zip_verify_40_polys_r14d1,
    zip_verify_40_polys_r14d2
);
