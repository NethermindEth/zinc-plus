...
{
    pub binary:
        <<P as ZincPCSTypes<Zt, F, D>>::BinaryPCS as PCS<F, BinaryPoly<D>, D>>::OpeningProof,
    pub arbitrary: <<P as ZincPCSTypes<Zt, F, D>>::ArbitraryPCS as PCS<
        F,
        DensePolynomial<Zt::Int, D>,
        D,
    >>::OpeningProof,
    pub int: <<P as ZincPCSTypes<Zt, F, D>>::IntPCS as PCS<F, Zt::Int, D>>::OpeningProof,
}

impl<P, Zt, F, const D: usize> Default for PCSOpeningProof<P, Zt, F, D>
where
    Zt: ZincTypes<D>,
    F: PrimeField,
    P: ZincPCSTypes<Zt, F, D>,
