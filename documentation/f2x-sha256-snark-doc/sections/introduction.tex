...
with their operands read off through a second weighting $\psiz$ of the cell.
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item isolates all nonlinearity into column Hadamard products, recasts
    them as a polynomial ideal-membership claim discharged on the same
    pipeline, and binds them to the commitment via $\psiz$, with no second
    opening and no second point;
