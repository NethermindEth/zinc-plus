...
pub fn sumcheck_benches(c: &mut Criterion) {
    ...
    bench_sum_of_40::<MontyField<3>, 3>(&mut group, 1 << 11);
    bench_sum_of_40::<MontyField<3>, 3>(&mut group, 1 << 12);
    bench_sum_of_40::<MontyField<3>, 3>(&mut group, 1 << 13);
    bench_sum_of_40::<MontyField<3>, 3>(&mut group, 1 << 14);
