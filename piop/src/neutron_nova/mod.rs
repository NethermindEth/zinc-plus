...
pub use projection_sha::{
    ...
    PreparedCanonicalShaBooleanityBasis, PreparedShaBooleanityBasis, PreparedShaResidualBasis,
    ...
    build_sha_sumfold_quadratic_prefix_accumulator_from_bases, check_fresh_sha_ideal_cache,
    ...
    prepare_sha_sumfold_basis, production_sha_booleanity_sources, production_sha_nonzero_families,
