...
pub use fold_first::{
    ...
    FoldFirstVerifierClaims, GramAccumulator, ShaSourceMasks, SkipDomain, SkipRoundVerdict,
    absorb_fold_first_ideal_polys, accumulate_booleanity_gram,
    accumulate_booleanity_gram_reference, accumulate_booleanity_gram_with_masks,
    build_fold_first_ideal_polys, fold_projected_traces_with_theta_masks,
    prove_fold_first_sha_sumfold, prove_skip_round, sha_nonzero_target_at,
    verify_fold_first_sha_sumfold, verify_skip_round,
};
pub use linear_cpr::{
...
pub use projection_sha::{
    ...
    PreparedCanonicalShaBooleanityBasis, PreparedProductionShaNativeView,
    PreparedShaBooleanityBasis, PreparedShaQuadraticPrefixArtifacts, PreparedShaResidualBasis,
    PreparedShaResidualFamily, PreparedShaResidualRow, PreparedShaResidualTerm,
    PreparedShaSmallResidualBasis, PreparedShaSmallResidualFamily, PreparedShaSmallResidualRow,
    PreparedShaSmallResidualTerm, PreparedShaSumFoldBasis, ProjectedPublic, ProjectedTrace,
    ProjectionFoldAccumulator, ProjectionFoldWitness, SHA_ROW_COUNT, SHA_ROW_VARS, SHA_WORD_BITS,
    ShaAggregateIdealWeightPlan, ShaBinaryFoldField, ShaBooleanityCatalog, ShaBooleanitySource,
    ShaIntCol, ShaLinearAccumulatorField, ShaLinearResidualWeightPlan, ShaProductionIdeal,
    ShaProjectionError, ShaPublicCol, ShaPublicWordCol, ShaResidualFamily, ShaSmallFieldDecode,
    ShaSuffixScannerField, ShaWordCol, VirtualChMajValues, beta_aggregate_nonzero_ideal_polys,
    ...
    production_sha_booleanity_sources, production_sha_booleanity_sources_for,
