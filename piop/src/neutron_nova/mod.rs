...
pub use projection_sha::{
    ...
    ShaIntColumns, ShaLinearResidualCoeffCache, ShaProductionIdeal, ShaProjectionError,
    ShaPublicCol, ShaPublicColumns, ShaPublicWordCol, ShaPublicWordColumns, ShaResidualFamily,
    ShaScalarizedRows, ShaSumFoldOutput, ShaWordCol, VirtualChMajValues,
