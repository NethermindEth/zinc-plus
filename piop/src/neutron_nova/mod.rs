...
pub use projection_sha::{
    ...
    SHA_WORD_BITS, ShaAggregateIdealWeightPlan, ShaBinaryFoldField, ShaBooleanitySource, ShaIntCol,
    ...
    beta_aggregate_nonzero_ideal_polys, beta_aggregate_nonzero_ideal_polys_direct_with_weights,
    ...
    build_sha_sumfold_quadratic_prefix_accumulator, check_fresh_sha_ideal_cache,
