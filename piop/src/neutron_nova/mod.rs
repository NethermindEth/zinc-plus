...
pub use projection_sha::{
    ...
    MleColumn, MleTable, NUM_NONZERO_SHA_FAMILIES, NUM_SHA_RESIDUAL_FAMILIES, ProjectedPublic,
    ProjectedTrace, ProjectionFoldAccumulator, ProjectionFoldWitness, SHA_ROW_COUNT, SHA_ROW_VARS,
    SHA_WORD_BITS, ShaBooleanitySource, ShaIntCol, ShaProductionIdeal, ShaProjectionError,
    ShaPublicCol, ShaPublicWordCol, ShaResidualFamily, ShaWordCol, VirtualChMajValues,
    beta_aggregate_nonzero_ideal_polys, beta_aggregate_nonzero_ideal_polys_with_weights,
    bit_slice_index, build_booleanity_weights, build_dense_sha_sumfold_group,
    build_dense_sha_sumfold_group_with_weights, build_expression_folded_row_sumcheck_group,
    ...
    build_sha_sumfold_linear_accumulator, build_sha_sumfold_quadratic_prefix_accumulator,
    check_fresh_sha_ideal_cache, check_sha_ideal_values, derive_instance_fold_claim,
    evaluate_fresh_sha_targets, expression_folded_row_sum,
    expression_folded_row_sum_with_row_weights, expression_folded_row_sum_with_vectors,
    fold_projected_traces, folded_row_integrand_sum, folded_row_integrand_values,
    ...
    sha_int_at_point, sha_int_at_point_with_weights, sha_linear_residual_row_value,
    sha_linear_residual_sum, sha_public_at_point, sha_public_at_point_with_weights,
    sha_scalarized_word_at_point, sha_scalarized_word_at_point_with_weights,
    sha_word_bits_at_point, sha_word_bits_at_point_with_weights,
    validate_fresh_sha_ideal_polys_canonical, verify_folded_row_sumcheck_claim,
    verify_folded_scalarization_links, verify_folded_scalarization_links_at_point,
    verify_folded_shifted_scalarization_link_at_point, verify_fresh_sha_ideal_polys,
};
