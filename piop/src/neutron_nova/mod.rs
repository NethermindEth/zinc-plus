...
pub use projection_sha::{
    ...
    expression_folded_row_sum, finalize_sha_sumfold, fold_projected_sha_traces,
    folded_row_integrand_sum, folded_row_integrand_values, production_sha_booleanity_sources,
