...
pub use projection_sha::{
    ...
    bit_slice_index, build_dense_sha_sumfold_group, build_dense_sha_sumfold_group_with_weights,
    ...
    derive_instance_fold_claim, evaluate_fresh_sha_targets, expression_folded_row_sum,
    expression_folded_row_sum_with_row_weights, fold_projected_traces, folded_row_integrand_sum,
